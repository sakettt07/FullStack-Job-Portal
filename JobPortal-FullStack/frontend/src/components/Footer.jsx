        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
                <a href="https://pagedone.io/"  className="flex justify-center ">
                    <img classNameName='w-20' src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/4dbe2e83261589.5d371e45eed23.png" alt="" />
                ...
                <ul className="text-lg text-center sm:flex items-cente justify-center gap-14 lg:gap-10 xl:gap-14 transition-all duration-500">
                    ...
                    <li className="sm:my-0 my-2" ><a href="javascript:;"  className="text-white hover:text-gray-400">Products</a></li>
                    <li ><a href="javascript:;"  className="text-white hover:text-gray-400">Resources</a></li>
                    <li  className="sm:my-0 my-2"><a href="javascript:;"  className="text-white hover:text-gray-400">Blog</a></li>
